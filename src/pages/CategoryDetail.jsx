...
export default function CategoryDetail() {
  ...
  if (!machine || !category) {
    return (
      <div className="text-center py-24">
        ...
        <Link to={machine ? `/maquinas/${machineId}` : '/'} className="inline-flex items-center gap-2 px-4 py-2 bg-blue-700 text-white font-semibold rounded-xl hover:bg-blue-800 transition-colors">
          Volver
        </Link>
      </div>
    );
  ...
  return (
    <div className="max-w-4xl">
      {/* Header */}
      <div className="mb-10">
        <div className="inline-flex items-center gap-2 text-xs font-semibold text-blue-700 bg-blue-50 px-3 py-1 rounded-full mb-4 uppercase tracking-wider">
          {machine.name}
        </div>
