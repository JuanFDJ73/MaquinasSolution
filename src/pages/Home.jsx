...
export default function Home() {
  return (
    <div>
      ...
      {/* Machines Grid */}
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-slate-900 mb-2">Máquinas disponibles</h2>
        <p className="text-slate-500 text-lg mb-8">Selecciona una máquina para acceder a su manual técnico completo.</p>
